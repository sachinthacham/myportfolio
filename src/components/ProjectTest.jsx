...
const ProjectTest = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-8 md:px-16 lg:px-24">
      <h2 className="text-4xl font-bold text-center mb-12"><span className='text-[#ff014f]'>Creations</span> I've Been a Part Of</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           className="bg-[#202020] p-6 rounded-lg hover:shadow-lg transform transition-transform duration-300 hover:scale-105">
